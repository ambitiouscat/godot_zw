...
def configure(env: "SConsEnvironment"):
    ...
    if env["opengl3"]:
        ...
        # EGL and GLESv3 are loaded at runtime by GLAD via dlopen, no link-time dependency needed.

    # Public directory access (for default project path in editor).
    env.Append(LIBS=["ohenvironment"])
